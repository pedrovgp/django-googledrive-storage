"""
Django settings for gdtest project.
...
SECRET_KEY = "&$)zvzgmzpvnot6_p7_6u@&#ea$@c7^j*(0%9g+iy%=yju07k%"
...
WSGI_APPLICATION = "gdtest.wsgi.application"
