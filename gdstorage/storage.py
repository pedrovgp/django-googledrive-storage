...
class GoogleDriveFilePermission(object):
    ...
    def raw(self):
        ...
        result = {"role": self.role.value, "type": self.type.value}
...
class GoogleDriveStorage(Storage):
    ...
    def _get_or_create_folder(self, path, parent_id=None):
        ...
        meta_data = {"name": split_path[-1], "mimeType": self._GOOGLE_DRIVE_FOLDER_MIMETYPE_}
    ...
    def _save(self, name, content):
        ...
        file_data = self._drive_service.files().create(body=body, media_body=media_body).execute()
